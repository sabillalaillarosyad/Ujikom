...
<center>
  <h2>Edit Siswa <?php echo $data['nama']; ?></h2>
      ...
      <section class="base">
        ...
        <input name="no" value="<?php echo $data['no']; ?>"  required="" />
        <div>
          <label>nisn</label>
        ...
        <label>no telp</label>
         <input type="text" name="no telp" value="<?php echo $data['no telp']; ?>" required=""/>
        </div>
        ...
        <label>id spp</label>
         <input type="text" name="id spp" value="<?php echo $data['id spp']; ?>" required=""/>
        </div>

        <label>action</label>
         <input type="text" name="action" value="<?php echo $data['action']; ?>" required=""/>
        </div>
